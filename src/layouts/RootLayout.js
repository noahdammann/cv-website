            ...
            <div className="root-layout">
                ...
                <header id="navbar-container" className={showRootLayout ? "" : "navbar-hide"}>
                    <nav>
                        ...
                        <div className="menu">
                            <NavLink to="/" onClick={handleHandburger} className="menu-item">Home</NavLink>
                            <NavLink to="examples" onClick={handleHandburger} className="menu-item">Examples</NavLink>
                            <NavLink to="pricing" onClick={handleHandburger} className="menu-item">Pricing</NavLink>
                            <NavLink to="start-quiz" onClick={handleHandburger} className="menu-item">Quiz</NavLink>
                        </div>

                        <div className="links-container">
                            <NavLink to="/" className="testing-a">Home</NavLink>
                            <NavLink to="examples" className="testing-a">Examples</NavLink>
                            <NavLink to="pricing" className="testing-a">Pricing</NavLink>
                            <NavLink to="start-quiz" className="testing-a">Quiz</NavLink>
                        </div>
                    </nav>
                </header>
                ...
                <footer className={showRootLayout ? "" : "footer-hide"}>
                    <div className="footer-columns">
                        ...
                        <div className="footer-column">
                            ...
                            <NavLink to="start-quiz">Quiz</NavLink>
                        ...
                        <div className="footer-column">
                            ...
                            <NavLink to="revisions-policy">Revisions Policy</NavLink>
